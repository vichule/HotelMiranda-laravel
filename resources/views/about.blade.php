...
@section('content')
    <section class="bannerGeneric">
        ...
        <div class="bannerGeneric__nav">
            ...
            <p>|</p>
            <a href="{{ route('about') }}" id="currentBtn">About Us</a>
        </div>
    </section>
    ...
    <section class="counter">
        ...
        <div class="swiper counter__slide">
            <div class="swiper-wrapper">
                <div class="swiper-slide"><img id="counterImg" src={{ asset('./assets/about/counter1.jpg') }}
                        alt=""></div>
                <div class="swiper-slide"><img id="counterImg" src={{ asset('./assets/about/counter2.jpg') }}
                        alt=""></div>
